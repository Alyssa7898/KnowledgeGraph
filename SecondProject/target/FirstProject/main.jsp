...
<div region="west" style="width: 200px;height:500px;" title="导航菜单" split="true" data-options="iconCls:'icon-nav'">
    <div class="easyui-accordion">
        <div title="关系图谱" data-options="iconCls:'icon-link'" style="padding:10px">
            ...
            <a href="javascript:openTab('节点操作','node.jsp','icon-operate_point')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-operate_point'"
               style="width: 150px;">节点操作</a>
            <a href="javascript:openTab('关系操作','line.jsp','icon-operate_link')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-operate_link'" style="width: 150px;">关系操作</a>
        </div>
        ...
        <div title="系统管理" data-options="iconCls:'icon-manager'" style="padding:10px;border:none;">
            <a id="userList" href="javascript:openTab('用户列表','userManage.jsp','icon-user')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-user'" style="width: 150px;"> 用户列表</a>
            <a
